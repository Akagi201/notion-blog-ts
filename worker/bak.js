...
const MY_DOMAIN = "subdomain.example.com";
...
const SLUG_TO_PAGE = {
	"": "page id here",
	portfolio: "page id here",
};

/* Step 3: enter your page title and description for SEO purposes */
const PAGE_TITLE = "Your Title";
const PAGE_DESCRIPTION = "Your Site Description";
...
async function fetchAndApply(request) {
	...
	url.hostname = "yournotion.notion.site";
	...
	if (url.pathname.startsWith("/app") && url.pathname.endsWith("js")) {
		...
		response = new Response(
			body
				.replace(/yournotion.notion.site/g, MY_DOMAIN)
		...
		return response;
		// update as per https://github.com/stephenou/fruitionsite/pull/243/files/b980cd435f420f218fb4780393455eb9710e508f#diff-fdd59fc971c44b2f1c722633412abe173c9505fed3edb1025926d93c32a3faa9
...
class BodyRewriter {
	...
	element(element) {
      ...
      window.XMLHttpRequest.prototype.open = function() {
        arguments[1] = arguments[1].replace('${MY_DOMAIN}', 'yournotion.notion.site');
